...
window.onload = function() {
  ...
  document.onkeydown = function checkKey(e) {
    if (e.keyCode == arrowLeftKeyCode || e.keyCode == arrowUpKeyCode ||
        e.keyCode == arrowRightKeyCode || e.keyCode ==  arrowDownKeyCode) {
    ...
    switch (e.keyCode) {
      ...
      case arrowDownKeyCode:
        if (isLeftPanelSelected && leftPanelSelectedIndex < leftPanelItems.length - 1) {
          leftPanelSelectedIndex++;
